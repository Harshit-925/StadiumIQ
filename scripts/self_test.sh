...
check "PocketBase migration versioned" "[ -n \"\$(ls pb_migrations 2>/dev/null)\" ]"
check "HistoryChart uses PocketBase SDK" "grep -q 'pocketbase\|pb\.' frontend/src/components/HistoryChart.tsx"
