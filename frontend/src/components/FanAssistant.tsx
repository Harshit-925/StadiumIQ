...
const WELCOME_MESSAGES: Record<SupportedLanguage, string> = {
  en: "Hello! I'm your FIFA World Cup 2026 fan assistant. Ask me anything about venues, match schedules, transport, or accessibility.",
...
const INPUT_PLACEHOLDERS: Record<SupportedLanguage, string> = {
  en: "Ask anything about WC 2026…",
  es: "Pregunta cualquier cosa sobre WC 2026…",
  fr: "Demandez n'importe quoi sur la CM 2026…",
  de: "Fragen Sie alles zur WM 2026…",
  pt: "Pergunte qualquer coisa sobre a CM 2026…",
  ja: "WC 2026について何でも聞いてください…"
};

const HINT_TEXTS: Record<SupportedLanguage, string> = {
  en: "Press Enter to send",
  es: "Presiona Enter para enviar",
  fr: "Appuyez sur Entrée pour envoyer",
  de: "Drücken Sie die Eingabetaste zum Senden",
