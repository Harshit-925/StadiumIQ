...
// Mock the background video so jsdom/axe doesn't hang trying to load media
vi.mock('../src/components/VideoBackground', () => ({
  default: () => <div data-testid="video-background" aria-hidden="true" />,
}));
